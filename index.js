...
function hungryDog(age, weight){
    if(age > 1 && weight < 5){ 
        return 0.44999999999999996 * weight; 
      }
      ...
      else if(age < 1 && weight >= 0.166 || weight <= 0.333){
        return 0.10 * weight;
      }
      else if(age < 1 && weight >= 0.333 || weight <= 0.583){
        return 0.05 * weight;
      }
      else if(age < 1 && weight >= 0.583 || weight <= 1.0){
        return 0.04 * weight;
      }
    }

  console.log(hungryDog(0.5, 12))
